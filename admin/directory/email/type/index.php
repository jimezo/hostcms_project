...
$oAdmin_Form_Controller
	...
	->title(Core::_('Directory_Email_Type.show_title'))
	->pageTitle(Core::_('Directory_Email_Type.show_title'));
...
$oAdmin_Form_Entity_Menus->add(
	Admin_Form_Entity::factory('Menu')
		->name(Core::_('Directory_Email_Type.email_type_show_title_add'))
		->icon('fa fa-plus')
...
->add(
	Admin_Form_Entity::factory('Breadcrumb')
		->name(Core::_('Directory_Email_Type.show_title'))
		->href(
...
{
	$Directory_Email_Type_Controller_Edit = Admin_Form_Action_Controller::factory(
		'Directory_Email_Type_Controller_Edit', $oAdmin_Form_Action
	);
	...
	$oAdmin_Form_Controller->addAction($Directory_Email_Type_Controller_Edit);
...
(
	Core_Entity::factory('Directory_Email_Type')
);
