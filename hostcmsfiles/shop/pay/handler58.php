 ...
 */
class Shop_Payment_System_Handler58 extends Shop_Payment_System_Handler
{
	/**
	...
	public function paymentProcessing($aResponse)
	{
		...
		$this->_shopOrder->system_information = sprintf("ТоварСайт2 оплачен через RBK Money. Данные платежа - amount:{$amount}, currency:{$currency}, id:{$id}");
