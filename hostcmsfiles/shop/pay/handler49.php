 ...
 *
 */
class Shop_Payment_System_Handler49 extends Shop_Payment_System_Handler
{
	/**
	...
	function ProcessResult()
	{
		...
		if ($request['status']=='20') {
			$this->_shopOrder->system_information = sprintf("ТоварСайт2 оплачен системой Cash24");
		...
		if ($request['status']=='30') {
			$this->_shopOrder->system_information = sprintf("ТоварСайт2 не оплачен системой Cash24");
		...
		if ($request['status']=='50') {
			$this->_shopOrder->system_information = sprintf("ТоварСайт2 возвращен системой Cash24");
			$this->_shopOrder->save();
			$this->setXSLs();
			$this->send();
			exit;
