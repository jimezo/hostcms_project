 ...
 * Почтовый перевод
 */
class Shop_Payment_System_Handler46 extends Shop_Payment_System_Handler
{
	...
	{
		$this->xsl(Core_Entity::factory('Xsl')->getByName('Форма112фСайт2'));
		return parent::getInvoice();
	}
	public function getNotification()
	{
		$this->xsl(Core_Entity::factory('Xsl')->getByName('ОплатаПочтовымПереводомСайт2'));
