...
<xsl:stylesheet version="1.0"
				...
				<form action="./" method="post">
					<xsl:if test="/informationsystem/siteuser_id = 0">
						<div class="row">
							...
							<div class="field">
								<input type="text" size="70" name="author" class="form-control" value="{/informationsystem/adding_item/author}"/>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="field">
								<input type="text" size="70" name="email" class="form-control" value="{/informationsystem/adding_item/email}" />
							</div>
						</div>
					</xsl:if>
					...
					<div class="row">
						...
						<div class="field">
							<input type="text" size="70" name="subject" class="form-control" value="{/informationsystem/adding_item/subject}"/>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="field">
							<textarea class="form-control" type="text" name="text" cols="68" rows="5">
	...
	<xsl:template match="informationsystem_item">
		...
		<div class="comment">
			<xsl:if test="name != ''">
				<div class="subject"><xsl:value-of select="name"/></div>
			</xsl:if>
			...
			<p class="item-comment">
				<xsl:choose>
					...
					<xsl:otherwise>
						<xsl:choose>
							<xsl:when test="property_value[tag_name='email']/value != '' and property_value[tag_name='author']/value != ''">
							<span><i class="fa fa-user"></i><a href="mailto:{property_value[tag_name='email']/value}"><xsl:value-of select="property_value[tag_name='author']/value"/></a></span>
							</xsl:when>
