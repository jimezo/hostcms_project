...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="shop">
		<h1 class="item_title" hostcms:id="{@id}" hostcms:field="name" hostcms:entity="shop">
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<div class="alert alert-warning">
					В данном магазине нет объявлений, доступных для редактирования.
				</div>
			</xsl:otherwise>
		</xsl:choose>
	...
	<xsl:template match="shop_item">
		<div class="row">
			<div class="col-xs-3 col-sm-4 col-md-3 col-lg-2" style="font-size: 11pt; font-weight:300; margin-top:10px;">
			...
			<div class="col-xs-3 col-sm-4 col-md-3 col-lg-5" style="font-size: 11pt; font-weight:300; margin-top:10px;">
			...
			<div class="col-xs-3 col-sm-4 col-md-3 col-lg-2" style="margin-top:10px;">
				<a href="{/shop/structure/link}{@id}/" style="text-decoration: none;"><i class="fa fa-pencil" style="margin-right: 5px;"></i></a>
				<a href="{/shop/structure/link}{@id}/delete/" onclick="return confirm('Вы действительно хотите удалить объявление?');"><i class="fa fa-trash"></i></a>
			</div>
		</div>
		<hr/>
	</xsl:template>
