		...
		$oRowElements = Admin_Form_Entity::factory('Div')
			...
			->add(
				Admin_Form_Entity::factory('Select')
					...
					->name($this->prefix . 'messenger' . ($oUser_Directory_Messenger ? '#' . $oUser_Directory_Messenger->id : '[]'))
			...
			->add(
				Admin_Form_Entity::factory('Input')
					->name($this->prefix . 'messenger_username' . ($oUser_Directory_Messenger ? '#' . $oUser_Directory_Messenger->id : '[]'))
			...
			if ($this->showPublicityControlElement)
			{
				...
				$oRowElements->add(
					Admin_Form_Entity::factory('Checkbox')
						...
						->name($this->prefix . 'messenger_public' . ($oUser_Directory_Messenger ? '#' . $oUser_Directory_Messenger->id : '[]'))
