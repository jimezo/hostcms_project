		...
		$oRowElements = Admin_Form_Entity::factory('Div')
			...
			->add(
				Admin_Form_Entity::factory('Select')
					...
					->name($this->prefix . 'social' . ($oUser_Directory_Social ? '#' . $oUser_Directory_Social->id : '[]'))
			...
			->add(
				Admin_Form_Entity::factory('Input')
					->name($this->prefix . 'social_address' . ($oUser_Directory_Social ? '#' . $oUser_Directory_Social->id : '[]'))
			...
			if ($this->showPublicityControlElement)
			{
				...
				$oRowElements->add(
					Admin_Form_Entity::factory('Checkbox')
						...
						->name($this->prefix . 'social_public' . ($oUser_Directory_Social ? '#' . $oUser_Directory_Social->id : '[]'))
