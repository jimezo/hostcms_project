		 ...
		 $oRowElements = Admin_Form_Entity::factory('Div')
			...
			->add(
				Admin_Form_Entity::factory('Select')
					...
					->name($this->prefix . 'phone_type' . ($oUser_Directory_Phone ? '#' . $oUser_Directory_Phone->id : '[]'))
			...
			->add(
				Admin_Form_Entity::factory('Input')
					->name($this->prefix . 'phone' . ($oUser_Directory_Phone ? '#' . $oUser_Directory_Phone->id : '[]'))
			...
			if ($this->showPublicityControlElement)
			{
				...
				$oRowElements->add(
					Admin_Form_Entity::factory('Checkbox')
						...
						->name($this->prefix . 'phone_public' . ($oUser_Directory_Phone ? '#' . $oUser_Directory_Phone->id : '[]'))
